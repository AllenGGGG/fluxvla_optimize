...
"""Normal-speed v1 checkpoint eval with adaptive arc-length retiming speed=2.0.

The VLA still predicts a normal 10-step chunk. The postprocess stage retimes
the denormalized delta-action path toward 5 executed steps, while preserving
